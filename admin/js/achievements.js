            ...
            if (achievementsParsedResponse['result']['status']['statusCode'] == "0") {
                ...
                for (let i = 0; i < achievementsDetails.length; i++) {
                    achievementsParsedResponseInfo += `<tr>
                        ...
                        <td>${achievementsDetails[i].description == null ? "" : achievementsDetails[i].description}</td>
                        <td>
        ...
        success: (response) => {
            ...
            if (editAchievementsParsedResponse['result']['status']['statusCode'] == "0") {
                ...
                if (achievementsDetail.length > 0) {
                    ...
                    $("#editDescription").val(achievementsDetail[0]['description']);
                    $("#editMore").val(achievementsDetail[0]['more']);
                    $("#editLink").val(achievementsDetail[0]['moreLink']);
                    $("#showEditIcons").html(`<i class="${achievementsDetail[0]['icon']}"></i> ${achievementsDetail[0]['icon']}`);
