<?php
	...
	try {
		...
		$data = [];
		$sql = "SELECT * FROM footer_menus WHERE id = '$footerMenuId' AND orgCode = '".$_SESSION['orgCode']."' ORDER BY id DESC";
		...
		if ($result) {
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                $subMenusql = "SELECT * FROM footer_sub_menus WHERE footermenu_id='$footerMenuId' AND deleted IS NULL AND orgCode = '".$_SESSION['orgCode']."'";
