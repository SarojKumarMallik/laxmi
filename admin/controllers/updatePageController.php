<?php
	...
	try {
        ...
        $sql = "UPDATE `pages` SET `title` = '$editTitle', `url` = '$editUrl', `html` = '$editHtml', `css` = '$editCss',  `javascript` = '$editJs', `isActive` = '$editStatus', `updated` = NOW() WHERE id = '$editPageId' AND orgCode = '".$_SESSION['orgCode']."'";
