<?php
	...
	try {
        ...
        $sql = "UPDATE `packages` SET `title` = '$editTitle', `price` = '$editPrice', `benifits` = '$editBenifits', `isActive` = '$editStatus', `updated` = NOW() WHERE id = '$editPackageId' AND orgCode = '".$_SESSION['orgCode']."'";
