<?php
	...
	try {
		...
		$data = [];
		$sql = "SELECT * FROM menus WHERE id = $mainMenuId AND orgCode = '".$_SESSION['orgCode']."' ORDER BY id DESC";
		...
		if ($result) {
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                $subMenusql = "SELECT * FROM sub_menus WHERE mainmenu_id='$mainMenuId' AND deleted IS NULL AND orgCode = '".$_SESSION['orgCode']."'";
