<?php
	...
	try {
        ...
        $editStatus = isset($_POST['editStatus']) ? 1 : 0;
			...
			$sql = "UPDATE `achievements` SET `icon` = '$editIcons', `numbers` = '$editNumbers', `title` = '$editTitle', `description` = '$editDescription', `moreLink` = '$editLink',`more` = '$editMore', `isActive` = '$editStatus', `updated` = NOW() WHERE id = '$achievementId' AND orgCode = '".$_SESSION['orgCode']."'";
