<?php
	...
	try {
		...
		if ($imageFile['name'] != "") {
			...
			$sql = "UPDATE `doctorsinfo` SET `name` = '$editName', `speciality` = '$editSpeciality', `about` = '$editAbout', `socialLinks` = '$socialLinks', `imgSrc` = '$imageName', `isActive` = '$aboutStatus', `updated` = NOW() WHERE id = '$doctorId' AND orgCode = '".$_SESSION['orgCode']."'";
		} else {
			$sql = "UPDATE `doctorsinfo` SET `name` = '$editName', `speciality` = '$editSpeciality', `about` = '$editAbout', `socialLinks` = '$socialLinks', `isActive` = '$aboutStatus', `updated` = NOW() WHERE id = '$doctorId' AND orgCode = '".$_SESSION['orgCode']."'";
		}
