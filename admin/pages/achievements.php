    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fs-5" id="addAchievementsModalLabel">Add Achievements</h5>
            ...
            <form id="addAchievementsForm">
                <div class="modal-body pb-5">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control" placeholder="More" rows="3" id="addMore"
                                name="addMore"></textarea>
                        </div>

                        <div class="col-md-6">
                            <input type="text" class="form-control" placeholder="More Link" id="addLink" name="addLink">
                        </div>
                        <div class="col-md-6">
...
<div class="modal fade" id="editAchievementsModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fs-5" id="editAchievementsModalLabel">Edit Achievements</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="editAchievementsForm">
                <div class="modal-body pb-5">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control" placeholder="More" rows="3" id="editMore"
                                name="editMore"></textarea>
                        </div>

                        <div class="col-md-6">
                            <input type="text" class="form-control" placeholder="More Link" id="editLink"
                                name="editLink">
                        </div>
                        <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <span class="fs-5 fw-bold">Achievements</span>
                            <div>
