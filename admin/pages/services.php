                ...
                <div class="modal-body pb-5">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <small style="color:red;">*Note: Choose Short for Home Page & Long for
                        ...
                        <div class="col-md-6">
                            <div class="custom-file-upload">
                                <input type="file" id="addBannerImageInput" name="addBannerImageInput" disabled>
                                <label for="addBannerImageInput"><i class="bi bi-upload me-2"></i>Upload
                                    Banner</label>
                            </div>
                            <img class="img-thumbnail" id="previewAddBannerImage" alt="Preview Image"
                                style="display: none;">
                        </div>
                    </div>
                </div>
            ...
            <form id="editServiceForm" enctype="multipart/form-data">
                <div class="modal-body pb-5">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="custom-file-upload">
                                <input type="file" id="editBannerImageInput" name="editBannerImageInput" disabled>
                                <label for="editBannerImageInput"><i class="bi bi-upload me-2"></i>Upload
                                    Banner</label>
                            </div>
                            <img class="img-thumbnail" id="previewEditBannerImage" alt="Preview Image"
                                style="display: none;">
                            <input type="hidden" name="editBannerImageHiddenFile" id="editBannerImageHiddenFile">
                            <img src="" id="storedViewBannerImage" class="img-thumbnail" style="display: none;">
                        </div>
                    </div>
                </div>
                <div class="modal-footer mt-5">
